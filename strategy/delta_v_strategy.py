...
# Model-specific confidence scaling (from CPCWE)
CONFIDENCE_SCALES = {
    'venus': 1.0,
    's3f': 1.0,
    'esm': 0.5,
...
def score_mutations(sequences, protein_id, wild_type, mutations, msa=None):
    ...
    if "stability" in assay_type:
        charge_multiplier = 0.90
        volume_multiplier = 0.95
        hydro_multiplier = 0.95
        gp_multiplier = 0.95
        aromatic_multiplier = 0.95
    elif "binding" in assay_type:
        charge_multiplier = 0.95
        volume_multiplier = 1.00
        hydro_multiplier = 1.00
        gp_multiplier = 1.00
        aromatic_multiplier = 1.00
        ...
        charge_multiplier = 0.925
        volume_multiplier = 0.975
        hydro_multiplier = 0.975
        gp_multiplier = 0.975
        aromatic_multiplier = 0.975
    else:
        charge_multiplier = 0.90
        volume_multiplier = 0.95
        hydro_multiplier = 0.95
    ...
    if msa_depth >= 500:
        base_w_venus, base_w_s3f, base_w_esm, base_w_gemme, base_w_prosst = 0.314, 0.236, 0.236, 0.125, 0.089
    else:
        base_w_venus, base_w_s3f, base_w_esm, base_w_gemme, base_w_prosst = 0.471, 0.236, 0.078, 0.125, 0.089
    ...
    calib_venus = _quantile_calibrate(venus_arr, 2.3, 1.0)
    calib_s3f = _quantile_calibrate(s3f_arr, 2.3, 1.0)
    calib_esm = _quantile_calibrate(esm_arr, 2.3, 1.0)
    calib_gemme = _quantile_calibrate(gemme_arr, 2.3, 1.0)
    calib_prosst = _quantile_calibrate(prosst_arr, 2.3, 1.0)
